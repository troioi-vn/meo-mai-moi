...
#[OA\Post(
    path: '/api/mcp/group-invitations/preview',
    summary: 'Preview a group invitation without putting its bearer token in the URL',
    ...
    responses: [
        new OA\Response(response: 200, description: 'Group invitation details'),
...
class McpPreviewGroupInvitationController extends Controller
{
