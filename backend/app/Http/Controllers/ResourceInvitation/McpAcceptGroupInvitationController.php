...
#[OA\Post(
    path: '/api/mcp/group-invitations/accept',
    summary: 'Accept a group invitation without putting its bearer token in the URL',
    ...
    responses: [
        new OA\Response(response: 200, description: 'Group invitation accepted'),
...
class McpAcceptGroupInvitationController extends Controller
{
    ...
    public function __invoke(Request $request, ResourceInvitationService $service): JsonResponse
    {
        ...
        try {
            ...
            $invitation->groupDetail?->group?->touch();
