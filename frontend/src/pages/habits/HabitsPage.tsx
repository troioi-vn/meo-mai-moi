...
import { getGetHabitsQueryKey, useGetHabits, usePostHabits } from "@/api/generated/habits/habits";
import { useGetMyPetsSections } from "@/api/generated/pets/pets";
import type { HabitPetSummary, PostHabitsBody } from "@/api/generated/model";
              ...
              <Card key={habit.id}>
                ...
                <CardContent className="space-y-3 text-sm text-muted-foreground">
                  ...
                  {habit.value_type === "integer_scale" && (
                    <div>
                      {t("card.scale", { min: habit.scale_min ?? 1, max: habit.scale_max ?? 10 })}
                    </div>
                  )}
                  <div>
