...
#[OA\Post(
    path: '/api/mcp/ledger-invitations/decline',
    summary: 'Decline a ledger invitation without putting its bearer token in the URL',
    ...
    responses: [
        new OA\Response(response: 204, description: 'Ledger invitation declined'),
...
class McpDeclineLedgerInvitationController extends Controller
{
