...
return [
    ...
    */
    'emails' => [
        ...
        'verification' => [
            ...
            'thanks_registering' => 'Thank you for creating an account with :app! To finish creating your account and start managing your cat\'s care, please verify your email address by clicking the button below.',
    ...
    */
    'telegram' => [
        ...
        'invalid_login_handshake' => 'This browser sign-in request has expired. Please start again from the sign-in page.',
        ...
        'invite_only' => 'Account creation is currently invite-only. If you already have an account, you can link it from Settings → Account in the app.',
