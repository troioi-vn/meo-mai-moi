 ...
 *
 *     @OA\Property(property="id", type="integer", format="int64", description="Response ID"),
 *     @OA\Property(property="placement_request_id", type="integer", format="int64", description="ID of the placement request"),
 *     @OA\Property(property="helper_profile_id", type="integer", format="int64", description="ID of the helper profile"),
 *     @OA\Property(property="status", type="string", enum={"responded", "accepted", "rejected", "cancelled"}, description="Current status of the response"),
 *     @OA\Property(property="message", type="string", nullable=true, description="Optional message from the helper"),
 *     @OA\Property(property="responded_at", type="string", format="date-time", description="When the helper responded"),
 *     @OA\Property(property="accepted_at", type="string", format="date-time", nullable=true, description="When the owner accepted"),
 *     @OA\Property(property="rejected_at", type="string", format="date-time", nullable=true, description="When the owner rejected"),
 *     @OA\Property(property="cancelled_at", type="string", format="date-time", nullable=true, description="When the helper cancelled"),
 *     @OA\Property(property="created_at", type="string", format="date-time", description="Creation timestamp"),
 *     @OA\Property(property="updated_at", type="string", format="date-time", description="Last update timestamp")
 * )
 *
 * @property-read \App\Models\PlacementRequest $placementRequest
 *
 * @method \Illuminate\Database\Eloquent\Builder|static accepted()
 * @method \Illuminate\Database\Eloquent\Builder|static blockingReResponse()
 * @method \Illuminate\Database\Eloquent\Builder|static active()
 */
