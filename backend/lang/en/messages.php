...
return [
    ...
    */
    'auth' => [
        ...
        'email_change_forbidden_verified' => 'Email address cannot be changed after verification.',
    ],
    ...
    */
    'telegram' => [
        ...
        'open_telegram_button' => 'Open in Telegram',
        'open_browser_button' => 'Open in browser',
        'already_linked' => 'Your Telegram account is already linked to :app_name! Click the button below to open the app in Telegram.',
        'browser_sign_in_approved' => '✅ Signed in as :name. Go back to your browser — you are already logged in.',
        'browser_sign_in_confirmation' => 'A browser is asking to sign in as you. Check that the code shown on the site is <b>:code</b>. If you did not just do this on the site, tap Cancel.',
        'browser_sign_in_new_account' => 'A browser is asking to create an account for you. Check that the code shown on the site is <b>:code</b>. If you did not just do this on the site, do not create an account.',
        'confirm_browser_sign_in_button' => 'Confirm sign-in',
        'cancel_browser_sign_in_button' => 'Cancel',
        'browser_sign_in_cancelled' => 'Browser sign-in cancelled.',
