...
#[OA\Post(
    path: '/api/mcp/resource-invitations/accept',
    summary: 'Accept a pet invitation without putting its bearer token in the URL',
    ...
    responses: [
        new OA\Response(response: 200, description: 'Pet invitation accepted'),
...
class McpAcceptPetInvitationController extends Controller
{
    ...
    public function __invoke(Request $request, ResourceInvitationService $service): JsonResponse
    {
        ...
        try {
            return $this->sendSuccess($service->accept($invitation, $user));
