...
const PetDetails: React.FC<PetDetailsProps> = ({
  ...
  const petTypeName = pet.pet_type?.name ?? t("pets:form.petType");
          ...
          {!supportsPlacement && (
            <div className="border-t pt-4">
              <p className="text-sm text-muted-foreground text-center">
                Placement requests are not available for {petTypeName.toLowerCase()}s at this time.
              </p>
            </div>
          )}
        </div>
