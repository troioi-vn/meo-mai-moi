        ...
        {!showConfirmation ? (
            ...
            {loading ? (
              ...
              <div className="grid gap-4 py-4">
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                  ...
                  <Select
                    onValueChange={setRequestedRelationshipType}
                ...
                {requestedRelationshipType === 'fostering' && (
                  <>
                    <div className="grid grid-cols-4 items-center gap-4">
                      ...
                      <Select
                        onValueChange={(v) => {
                          setFosteringType(v as 'free' | 'paid')
                        }}
                        value={fosteringType}
                      >
                        <SelectTrigger className="col-span-3">
              ...
              <div className="text-center">
                <p className="mb-4">
                  You must have a helper profile to respond to a placement request.
                </p>
                <Button
                  onClick={() => {
          ...
          <div className="py-4">
            ...
            <p>
              Helper Profile:{' '}
              {(() => {
                const p = helperProfiles.find((hp) => String(hp.id) === (selectedProfile ?? ''))
                return p ? `${p.city ?? ''}, ${p.state ?? ''}` : ''
              })()}
            </p>
            <p>
              Relationship Type: {(requestedRelationshipType ?? '').replace('_', ' ').toUpperCase()}
            </p>
            {requestedRelationshipType === 'fostering' && (
              <>
