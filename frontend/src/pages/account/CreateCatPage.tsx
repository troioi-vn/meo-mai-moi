      ...
      <div className="w-full max-w-2xl p-8 space-y-8 bg-neutral-50 rounded-lg shadow-lg dark:bg-neutral-800">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            <Label htmlFor="name" id="name-label" className="block">Name</Label>
            <Input
              id="name"
              name="name"
              type="text"
          ...
          <div className="space-y-2">
            <Label htmlFor="breed" id="breed-label" className="block">Breed</Label>
            <Input
              id="breed"
              name="breed"
              type="text"
          ...
          <div className="space-y-2">
            <Label htmlFor="age" id="age-label" className="block">Age</Label>
            <Input
              id="age"
              name="age"
              type="number"
          ...
          <div className="space-y-2">
            <Label htmlFor="location" id="location-label" className="block">Location</Label>
            <Input
              id="location"
              name="location"
              type="text"
          ...
          <div className="space-y-2">
            <Label htmlFor="description" id="description-label" className="block">Description</Label>
            <Textarea
              id="description"
              name="description"
              value={description}
