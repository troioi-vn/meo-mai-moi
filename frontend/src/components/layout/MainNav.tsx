...
const MainNav: React.FC = () => {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 w-full transform-gpu border-b bg-background/95 backdrop-blur will-change-transform supports-backdrop-filter:bg-background/60">
