...
export default function ApiTokensSettingsPage() {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      toast.error(t("developer.tokens.messages.loadErrorTitle"), {
        description: message,
      });
    } finally {
      setIsLoading(false);
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      toast(t("developer.tokens.messages.createSuccess"));
    } catch (error: unknown) {
      const payload =
        error instanceof AxiosError
      ...
      toast.error(t("developer.tokens.messages.createErrorTitle"), {
        description: message,
      });
    } finally {
  ...
  const handleUpdatePermissions = async () => {
    ...
    try {
      ...
      toast(t("developer.tokens.messages.updateSuccess"));
    } catch (error: unknown) {
      const message =
        error instanceof AxiosError
          ? ((error.response?.data as ApiErrorPayload | undefined)?.message ?? error.message)
      ...
      toast.error(t("developer.tokens.messages.updateErrorTitle"), {
        description: message,
      });
    } finally {
      setIsSubmitting(false);
  ...
  const handleRevoke = async () => {
    ...
    try {
      ...
      toast(t("developer.tokens.messages.revokeSuccess"));
    } catch (error: unknown) {
      const message =
        error instanceof AxiosError
          ? ((error.response?.data as ApiErrorPayload | undefined)?.message ?? error.message)
      ...
      toast.error(t("developer.tokens.messages.revokeErrorTitle"), {
        description: message,
      });
    } finally {
      setIsSubmitting(false);
  ...
  const copyPlaintextToken = async () => {
    ...
    try {
      ...
      toast(t("developer.tokens.createdDialog.copySuccess"));
    } catch {
      toast.error(t("developer.tokens.createdDialog.copyError"));
    }
  };
  ...
  const downloadPlaintextToken = () => {
    ...
    toast(t("developer.tokens.createdDialog.downloadSuccess"));
  };
