...
const mockPreferences: GetNotificationPreferences200Item[] = [
  {
    ...
    description: 'Response to Placement Request',
    group: 'helper_profile',
    group_label: 'Helper Profile',
    email_enabled: true,
    in_app_enabled: true,
  ...
  },
  {
    ...
    description: 'Placement Request Accepted',
    group: 'helper_profile',
    group_label: 'Helper Profile',
    email_enabled: false,
    in_app_enabled: true,
  ...
  },
  {
    ...
    description: 'Helper Response Accepted',
    group: 'helper_profile',
    group_label: 'Helper Profile',
    email_enabled: true,
  ...
  },
  {
    ...
    description: 'Helper Response Rejected',
    group: 'helper_profile',
    group_label: 'Helper Profile',
    email_enabled: false,
    in_app_enabled: false,
...
describe('NotificationPreferences Integration Tests', () => {
  ...
  it('handles multiple rapid preference changes correctly', async () => {
    ...
    if (!firstSwitch || !secondSwitch || !thirdSwitch) {
      throw new Error('Expected switches not found')
    }
    fireEvent.click(firstSwitch)
    fireEvent.click(secondSwitch)
    fireEvent.click(thirdSwitch)
  ...
  it('maintains UI state consistency during updates', async () => {
    ...
    const updatePromise = new Promise<string | null>((resolve) => {
    ...
    resolveUpdate?.('Updated successfully')
  ...
  it('groups preferences correctly by notification group', async () => {
    const preferencesWithGroups: GetNotificationPreferences200Item[] = [
      ...mockPreferences,
      {
  ...
  it('handles partial preference updates correctly', async () => {
    ...
    expect(inAppSwitch).toBeDefined()
    if (!inAppSwitch) throw new Error('Switch not found')
