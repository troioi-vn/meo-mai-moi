...
#[OA\Post(
    path: '/api/mcp/resource-invitations/preview',
    summary: 'Preview a pet invitation without putting its bearer token in the URL',
    ...
    responses: [
        new OA\Response(response: 200, description: 'Pet invitation details'),
...
class McpPreviewPetInvitationController extends Controller
{
