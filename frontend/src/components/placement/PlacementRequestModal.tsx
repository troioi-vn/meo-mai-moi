...
import { PostPlacementRequestsBodyRequestType } from '@/api/generated/model/postPlacementRequestsBodyRequestType'
...
export const PlacementRequestModal: React.FC<PlacementRequestModalProps> = ({
  ...
  const [startDate, setStartDate] = useState(initialValues?.start_date ?? undefined)
          ...
          <div className="grid gap-4 py-4">
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Select
                onValueChange={(value) => {
                  if (value) {
                    setRequestType(value as PostPlacementRequestsBodyRequestType)
                  }
                }}
                value={requestType}
              >
