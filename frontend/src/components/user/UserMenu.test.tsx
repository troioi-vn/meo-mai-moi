...
describe('UserMenu', () => {
  ...
  it('calls logout function when logout is clicked and confirmed', async () => {
    ...
    if (!(logoutButton instanceof HTMLElement)) throw new Error('Logout button not found')
    ...
    if (!(confirmButton instanceof HTMLElement)) throw new Error('Confirm button not found')
