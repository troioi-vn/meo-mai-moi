...
vi.mock('@/components/NotificationPreferences', () => ({
  NotificationPreferences: () => <div data-testid="notification-preferences">Notification Preferences Component</div>
}))
...
describe('NotificationsPage', () => {
  ...
  it('has correct breadcrumb links', () => {
    ...
    const breadcrumbAccountLink = accountLinks.find(link => 
