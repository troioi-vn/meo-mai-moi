...
1. Add the locale code to supported locales in `config/locales.php`:

   ```php
   'supported' => ['en', 'ru', 'vi'],  // Add 'vi'

   'names' => [
       'en' => 'English',
       'ru' => 'Русский',
       'vi' => 'Tiếng Việt',  // Add name
   ],
   ```
...
- `config/locales.php` (centralized locale configuration)
