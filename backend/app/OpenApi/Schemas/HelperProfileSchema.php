...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'status', type: 'string', enum: ['private', 'public', 'archived', 'deleted'], description: 'Status of the helper profile'),
        new OA\Property(property: 'request_types', type: 'array', items: new OA\Items(type: 'string', enum: ['foster_paid', 'foster_free', 'permanent', 'pet_sitting']), description: 'Types of placement requests this helper can respond to'),
