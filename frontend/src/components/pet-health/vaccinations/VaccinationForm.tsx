    ...
    >
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <div>
          <label className="block text-sm font-medium">
            {t('vaccinations.form.administeredOn')}
          </label>
          <div className="mt-1">
            <YearMonthDatePicker
        ...
        <div>
          <label className="block text-sm font-medium">
            {t('vaccinations.form.boosterInterval')}
          </label>
          <div className="relative mt-1">
            <input
              ...
              onBlur={() => {
                handleNumericBlur(setBoosterInterval, boosterInterval, 0, 120)
              }}
        ...
        <div>
          <label className="block text-sm font-medium">
            {t('vaccinations.form.scheduleEarly')}
          </label>
          <div className="relative mt-1">
            <input
              type="text"
              ...
              onBlur={() => {
                handleNumericBlur(setScheduleEarly, scheduleEarly, 0, 365)
              }}
      ...
      <div>
        <label className="block text-sm font-medium mb-1">
          {t('vaccinations.form.photo')}{' '}
          <span className="text-muted-foreground">({t('vaccinations.form.optional')})</span>
        </label>
